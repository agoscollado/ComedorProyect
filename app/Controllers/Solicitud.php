...
// Importamos UploadedFile porque lo usamos como "type hint" en guardarDocumento().
// Sin este use, PHP no sabría a qué clase nos referimos con solo el nombre corto.
...
class Solicitud extends BaseController
{
    ...
    public function crear()
    {
        ...
        // Reutilizamos el mismo método privado para los dos archivos,
        // en vez de repetir 2 veces el bloque de "generar nombre + mover + insertar".
        ...
        // Le decimos a la base "confirmá todo lo anterior de una,
        // o si algo salió mal en el medio, deshacé todo (rollback automático)".
        $db->transComplete();
    ...
    // private: este método es de uso interno del Controller,
    // nadie desde afuera (rutas, otros archivos) puede llamarlo directamente.
    // Cada parámetro tiene su tipo declarado (type hint), lo cual ayuda a evitar
    // errores tontos como pasar un string donde se esperaba un objeto UploadedFile.
    ...
    {
        // Generamos un nombre aleatorio y único para el archivo.
        // Evita que dos estudiantes que suben "dni.pdf" se pisen entre sí,
        // y evita que alguien adivine el nombre de un archivo ajeno.
        $nombreArchivo = $archivo->getRandomName();

        // WRITEPATH apunta siempre a la carpeta writable/ del proyecto,
        // sin importar el sistema operativo o dónde esté instalado CodeIgniter.
        // Guardamos ACA (no en public/) para que el archivo no sea accesible
        // directo por URL sin pasar por nuestro control de sesión/roles.
